...
public class ConfigActivity extends Activity {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == MSG_QUERY) {
                ...
                if (ar.exception == null) {
					...
					Log.e("@M_" + TAG,"Query failed for " + ((SettingView) ar.userObj).setting.label);
                    /*
    ...
    private abstract class SettingView extends FrameLayout {
        ...
        public SettingView(Context context, Setting setting) {
            ...
            TextView label = (TextView) findViewById(R.id.ims_config_label);
            TextView suffix = (TextView) findViewById(R.id.ims_config_suffix);
            Button button = (Button) findViewById(R.id.ims_config_set);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(mCategory);
        mList = (ViewGroup) findViewById(R.id.ims_item_list);
