...
public class OpSRIL extends RIL implements CommandsInterface {
    ...
    public OpSRIL(Context context, int networkMode, int cdmaSubscription) {
            super(context, networkMode, cdmaSubscription, null);
    }

    public OpSRIL(Context context, int networkMode, int cdmaSubscription, Integer instanceId) {
