...
CUSTOM_HAL_IMGSENSOR = ov8858_mipi_raw imx230_mipi_raw 
...
CUSTOM_HAL_SUB_LENS = 
CUSTOM_KERNEL_ACCELEROMETER = KXCJK1013
CUSTOM_KERNEL_ALSPS = stk3x1x-new
...
CUSTOM_KERNEL_IMGSENSOR = ov8858_mipi_raw imx230_mipi_raw
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = dw9714af dummy_lens
CUSTOM_KERNEL_MAGNETOMETER = akm09911_new_61
...
CUSTOM_KERNEL_TOUCHPANEL = gt9157_new_v24
CUSTOM_KERNEL_USB = mt6577
CUSTOM_KERNEL_VIBRATOR = vibrator
CUSTOM_MODEM = amoi6795_lwt_l1_lttg_l861 amoi6795_lwt_l1_lwg_l861
...
#amoi_app yangjt 2015-07-13 for configuration of single sim 
GEMINI = no
...
#amoi_app,yangjt,close this feature,2015-06-24
MTK_ANT_SUPPORT = no
MTK_API_CHECK = yes
...
MTK_BUILD_VERNO = ALPS.L1.MP2.V1_AMOI6795.LWT.CU_P18
MTK_BWC_SUPPORT = yes
...
#liandc@20150601@disable multicore observer app
MTK_MULTICORE_OBSERVER_APP = no
#amoi_app:huangsq open the multi sim ringtone function,20150608
...
#amoi_app:yangjt@20150617@disable shared sdcard
...
#amoi_app,yangjt,turn on this feature 2015-06-24
...
MTK_SWIP_VORBIS = yes
MTK_SWIP_WMAPRO = no
# liandc@20150629@close this feature
...
#begin:liandc@20150601@disable weather app
MTK_WEATHER_PROVIDER_APP = no
MTK_WEATHER_WIDGET_APP = no
#end:liandc@20150601@disable weather app
...
#amoi_app,yangjt,2015-08-06
MTK_BENCHMARK_BOOST_TP=yes

# begin: chenyf@20150527@Modify version number related
AMOI_PROJ_L861=yes
AMOI_STONEX_PROJ=yes
DT = $(shell date +%F)
AMOI_BUILD_VERNO=Ciao OS 1.03_$(DT)
# end: chenyf@20150527@Modify version number related

#chenyf 2015.02.06 add begin for oversea
AMOI_OVERSEA_VERSION=yes
#chenyf 2015.02.06 add end for oversea 
#CREATE_PROJECT_INFO=2015051921944
#yangjt 2015.03.02 add for oversea version with gms function
BUILD_GMS=yes

# amoi_app wuyz 20150601 add for AmoiPkgInstaller begin
AMOI_PKG_INSTALLER=no
# amoi_app wuyz 20150601 add for AmoiPkgInstaller end

# amoi_app wuyz 20150605 add for BLAUPUNKT recent task ui begin
# can run to Apps Manager/Google Search/Task Clean in the recent app
AMOI_RECENT_PANEL=no
# amoi_app wuyz 20150605 add for BLAUPUNKT recent task ui end
# liandc add begin
AMOI_SETTINGS_LED=yes
# liandc add end
#adupsfota start
...
#huangsq 2015.01.23 add begin for gesture wake
AMOI_GESTURE_WAKE=yes
#huangsq 2015.03.05 add begin for bootandshutdown ringsound
AMOI_BOOT_OFF_RINGSOUND=no
#jianglin 2015.03.11 add begin for REBOOT meunu
AMOI_REBOOT_MENU=yes
AMOI_RECOVERY_MENU=yes
#jianglin 2015.03.11 add end for REBOOT meunu 

# amoi_app wuyz 20150707 add for hall sensor smart cover begin
AMOI_KEYGUARD_HALL_SENSOR=yes
# amoi_app wuyz 20150707 add for hall sensor smart cover end

# amoi_app wuyz 20150723 add for StonexManual begin
AMOI_STONEX_MANUAL=yes
# amoi_app wuyz 20150723 add for StonexManual end

# amoi_app wuyz 20150910 add for stonex power saver begin
STONEX_POWER_SAVER=yes
