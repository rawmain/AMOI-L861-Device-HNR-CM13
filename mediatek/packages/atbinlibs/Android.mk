...
#include $(CLEAR_VARS)
#LOCAL_PREBUILT_STATIC_JAVA_LIBRARIES := mediatek-telephony-common:mediatek-telephony-common.jar
#include $(BUILD_MULTI_PREBUILT)

#include $(CLEAR_VARS)
#LOCAL_PREBUILT_STATIC_JAVA_LIBRARIES := mediatek-framework:mediatek-framework.jar
#include $(BUILD_MULTI_PREBUILT)
include $(CLEAR_VARS)
